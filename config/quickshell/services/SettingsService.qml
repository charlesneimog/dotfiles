...
Singleton {
    ...
    readonly property int barHeight: Math.max(14, Math.min(18, config.barHeight))
    readonly property int barMargin: 0
    readonly property bool islandAttached: true
    readonly property bool barFullWidth: false
    readonly property alias barSideMargin: config.barSideMargin
    readonly property string barStyle: "spread"
    ...
    readonly property var barDefaults: ({
        left: ["aur", "workspaces"],
        right: ["planify", "notifications", "network", "bluetooth", "volume", "battery"]
    })
