...
QtObject {
    ...
    readonly property var list: [
        {
            id: "impasto",
            name: "Impasto Original",
            badge: "Original",
            swatches: ["#000000", "#141414", "#0a84ff", "#ffffff"],
            colors: {
                background: "#000000", surface: "#ff0000", surfaceHover: "#1f1f1f",
                border: "#262626", text: "#ffffff", textMuted: "#8e8e93",
                accent: "#0a84ff", accentHover: "#409cff", accentText: "#ffffff",
                red: "#ff453a", green: "#32d74b", yellow: "#ffd60a", blue: "#0a84ff"
            }
        },
        {
            id: "catppuccin_mocha",
