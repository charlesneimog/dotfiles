...
Item {
    ...
    readonly property string value: root.barMode
        ? ModuleService.barValueOf(root.moduleId) : ModuleService.valueOf(root.moduleId)
    readonly property bool figured: root.value !== ""
    readonly property int size: Math.min(11, Theme.capsuleHeight - 4)
