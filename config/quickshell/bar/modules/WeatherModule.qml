            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Text {
                            Layout.fillWidth: true
                            text: WeatherService.available ? WeatherService.place : "Weather unavailable"
                    ...
                    Text {
                        Layout.fillWidth: true
                        text: {
                            if (WeatherService.error) return WeatherService.error
                            if (!WeatherService.available) return "Checking weather…"
                            const parts = []
                            ...
                            if (WeatherService.provider) parts.push(WeatherService.provider)
                            return parts.join(" · ")
                        }
                        elide: Text.ElideRight
                        font.family: Theme.fontFamily
